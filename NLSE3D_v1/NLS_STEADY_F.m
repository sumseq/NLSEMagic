%NLS_STEADY_F Steady-state 1D ODE for finding vortex radial profiles.
...
function NLS_STEADY_F = NLS_STEADY_F(Uguess,par)
...
%Send back F:
NLS_STEADY_F = -OM*Uguess - (a*m^2./rvec.^2).*Uguess + a*Ulap + s.*Uguess.^3;
NLS_STEADY_F = [0;NLS_STEADY_F;0];
