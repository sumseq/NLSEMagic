...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
    ...
    if(precision==1){
      ...
      /*Call integrator*/
      NLSE2D_TAKE_STEPS_F(fUoldr,fUoldi,fV,vUnewr,vUnewi,(float)s,(float)a,(float)h2,BC,
      ...
      free(fV);
        ...
        /*Call integrator*/
        NLSE2D_TAKE_STEPS(vUoldr,vUoldi,vV,vUnewr,vUnewi,s,a,h2,BC,chunk_size,k,N,M,method);
    }
