...
xreswantedv    = 0;      %Desired grid size (N, N x N) (Overwrites IC auto grid-size calculations, and may be slightly altered)
...
colormap(hsv(512));
%colormap(bone(500));
axis([xmin xmax ymin ymax 0 (maxMod2U+maxMod2U)]);
...
if(plot_vorticity==1)
    ...
    fig_count = fig_count+1;
    pfig_vort = surf(X,Y,W);
    set(fig_vort, 'Name','2D NLSE Vorticity  t = 0','NumberTitle','off');
    shading interp;
    grid off
...
if(plot_phase==1)
    ...
    fig_count  = fig_count+1;
    pfig_phase = surf(X,Y,angle(U));
    set(fig_phase, 'Name','Phase  t = 0','NumberTitle','off');
    shading interp;
    grid off
    xlabel('x','FontSize',fsize);
    ylabel('y','FontSize',fsize);
...
if(save_images==1)
    if(plot_modulus2==1) 
       ...
       if(plot_r_and_im==1)           
           print('-depsc','-r100','-opengl',[fn '_MOD2_3D_t=0'],['-f',num2str(fig_mod2)]); 
       else
           print('-depsc','-r100','-opengl',[fn '_MOD2_t=0'],['-f',num2str(fig_mod2)]); 
       end
    end
    if(plot_vorticity==1)    
       set(fig_vort, 'PaperPositionMode', 'auto'); 
       print('-depsc','-r100','-opengl',[fn '_VORT_t=0'],['-f',num2str(fig_vort)]);   
    end
    if(plot_phase==1)       
      set(fig_phase, 'PaperPositionMode', 'auto'); 
      print('-depsc','-r100','-opengl',[fn '_PHASE_t=0'],['-f',num2str(fig_phase)]);   
    end       
end
if(save_images==2)
    if(plot_modulus2==1) 
       set(fig_mod2, 'PaperPositionMode', 'auto'); 
       print('-djpeg','-r100','-opengl',[fn '_MOD2_t=0.jpg'],['-f',num2str(fig_mod2)]); 
    end
    if(plot_vorticity==1)       
       set(fig_vort, 'PaperPositionMode', 'auto'); 
       print('-djpeg','-r100','-opengl',[fn '_VORT_t=0.jpg'],['-f',num2str(fig_vort)]);   
    end
    if(plot_phase==1)     
      set(fig_phase, 'PaperPositionMode', 'auto'); 
      print('-djpeg','-r100','-opengl',[fn '_PHASE_t=0.jpg'],['-f',num2str(fig_phase)]);   
    end       
end
...
if(save_images==1)
    if(plot_modulus2==1) 
       set(fig_mod2, 'PaperPositionMode', 'auto'); 
       print('-depsc','-r100','-opengl',[fn '_MOD2_t=' num2str(n*k) '.eps'],['-f',num2str(fig_mod2)]);   
    end
    if(plot_vorticity==1)        
       set(fig_vort, 'PaperPositionMode', 'auto'); 
       print('-depsc','-r100','-opengl',[fn '_VORT_t=' num2str(n*k) '.eps'],['-f',num2str(fig_vort)]);   
    end
    if(plot_phase==1)        
      set(fig_phase, 'PaperPositionMode', 'auto'); 
      print('-depsc','-r100','-opengl',[fn '_PHASE_t=' num2str(n*k) '.eps'],['-f',num2str(fig_phase)]);   
    end       
end
if(save_images==2)
    if(plot_modulus2==1) 
       set(fig_mod2, 'PaperPositionMode', 'auto'); 
       print('-djpeg','-r100','-opengl',[fn '_MOD2_t=' num2str(n*k) '.jpg'],['-f',num2str(fig_mod2)]);   
    end
    if(plot_vorticity==1)        
       set(fig_vort, 'PaperPositionMode', 'auto'); 
       print('-djpeg','-r100','-opengl',[fn '_VORT_t=' num2str(n*k) '.jpg'],['-f',num2str(fig_vort)]);   
    end
    if(plot_phase==1)        
       set(fig_phase, 'PaperPositionMode', 'auto'); 
      print('-djpeg','-r100','-opengl',[fn '_PHASE_t=' num2str(n*k) '.jpg'],['-f',num2str(fig_phase)]);   
    end       
end
...
if(track_vortices==1 && IC==3)
   ...
   if(length(rv)==1)
      ...
      print('-djpeg','-r100',['msd_2vort_BC',num2str(BC),'_xvsy',num2str(endt)],['-f',num2str(fig_xytrace)]); 
      print('-depsc','-r100',['msd_2vort_BC',num2str(BC),'_xvsy',num2str(endt)],['-f',num2str(fig_xytrace)]); 
   end  
   ...
   if(length(rv)==1)
      ...
      print('-djpeg','-r100',['msd_2vort_BC',num2str(BC),'_xvst',num2str(endt),'.jpg'],['-f',num2str(fig_xvst)]); 
      print('-depsc','-r100',['msd_2vort_BC',num2str(BC),'_xvst',num2str(endt),'.eps'],['-f',num2str(fig_xvst)]); 
   end
   ...
   if(length(rv)==1)
      ...
      print('-djpeg','-r100',['msd_2vort_BC',num2str(BC),'_rvst',num2str(endt),'.jpg'],['-f',num2str(fig_rvst)]); 
      print('-depsc','-r100',['msd_2vort_BC',num2str(BC),'_rvst',num2str(endt),'.eps'],['-f',num2str(fig_rvst)]); 
   end
...
if(length(rv)>1 && length(BCv)>1)
   ...
   print('-djpeg','-r100',['MSD_2D_T',num2str(endt),'_k',num2str(k),'_h',num2str(h),'_r',num2str(min(rv)),'-',num2str(max(rv)),'_f',num2str(numframes),'.jpg'],['-f',num2str(fig_msd)]); 
   print('-depsc','-r100',['MSD_2D_T',num2str(endt),'_k',num2str(k),'_h',num2str(h),'_r',num2str(min(rv)),'-',num2str(max(rv)),'_f',num2str(numframes),'.eps'],['-f',num2str(fig_msd)]); 
   if(track_vortices==1)
      set(fig_msd2, 'PaperPositionMode', 'auto');  
      print('-djpeg','-r100',['MSD_2D_T',num2str(endt),'_k',num2str(k),'_h',num2str(h),'_r',num2str(min(rv)),'-',num2str(max(rv)),'_f',num2str(numframes),'.jpg'],['-f',num2str(fig_msd2)]); 
      print('-depsc','-r100',['MSD_2D_T',num2str(endt),'_k',num2str(k),'_h',num2str(h),'_r',num2str(min(rv)),'-',num2str(max(rv)),'_f',num2str(numframes),'.eps'],['-f',num2str(fig_msd2)]); 
   end
end
...
if(length(numframesv)>1)
   ...
   hold off;
   set(gcf, 'PaperPositionMode', 'auto');       
   print('-djpeg','-r100',['2D_T',num2str(endt),'_N',num2str(min(xreswantedv)),'_',num2str(max(xreswantedv)),'_M',num2str(method),'.jpg'],['-f',num2str(fig_frames)]); 
   print('-depsc','-r100',['2D_T',num2str(endt),'_N',num2str(min(xreswantedv)),'_',num2str(max(xreswantedv)),'_M',num2str(method),'.eps'],['-f',num2str(fig_frames)]); 
end
end %cuda
