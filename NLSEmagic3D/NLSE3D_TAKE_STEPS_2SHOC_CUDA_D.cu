...
__global__ void compute_F(double* ktotr, double* ktoti,
                          ...
                          int BC,       int L,
                          int N,        int M,  int gridDim_y, double K, int fstep)
{
    /*Declare shared memory space*/
    __shared__ double sUtmpr[BLOCK_SIZEZ+2][BLOCK_SIZEY+2][BLOCK_SIZEX+2];
    __shared__ double sUtmpi[BLOCK_SIZEZ+2][BLOCK_SIZEY+2][BLOCK_SIZEX+2];
    ...
    __shared__ double    sDr[BLOCK_SIZEZ+2][BLOCK_SIZEY+2][BLOCK_SIZEX+2];
    __shared__ double    sDi[BLOCK_SIZEZ+2][BLOCK_SIZEY+2][BLOCK_SIZEX+2];
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
    ...
    cudaMalloc((void**) &Dr,        M*N*L*sizeof(double));
    cudaMalloc((void**) &Di,        M*N*L*sizeof(double));
...
nvmex -f nvmexopts.bat NLSE3D_TAKE_STEPS_2SHOC_CUDA_D.cu -IC:\cuda\include -LC:\cuda\lib -lcudart
*/
