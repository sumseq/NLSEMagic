...
if(strcmp(opsys,'PCWIN')) 
  mex NLSEmagic2D_Take_Steps_GPU.c NLSEmagic2D_GPU.obj -L"C:\Program Files\NVIDIA GPU Computing Toolkit\CUDA\v6.5\lib\Win32" -lcudart
elseif(strcmp(opsys,'PCWIN64'))
  mex NLSEmagic2D_Take_Steps_GPU.c NLSEmagic2D_GPU.obj -L"C:\Program Files\NVIDIA GPU Computing Toolkit\CUDA\v6.5\lib\Win64" -lcudart
