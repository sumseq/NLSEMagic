...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
    ...
    if(precision==1){
      ...
      /*Call integrator*/
      NLSE1D_TAKE_STEPS_F(fUoldr,fUoldi,fV,fUnewr,fUnewi,(float)s,(float)a,(float)h2,BC,
                          chunk_size,(float)k,N,method);
      ...
      free(fUnewi);
        ...
        /*Call integrator*/
        NLSE1D_TAKE_STEPS(Uoldr,Uoldi,V,Unewr,Unewi,s,a,h2,BC,chunk_size,k,N,method);
    }
