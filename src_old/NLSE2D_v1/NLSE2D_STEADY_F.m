%NLSE2D_STEADY_F Stead-state 2D PDE for finding co-moving solutions.
...
function NLSE2D_STEADY_F = NLSE2D_STEADY_F(U,par)
...
%Send back F:
NLSE2D_STEADY_F = -OM*U + a*LAP + s.*U.^2.*conj(U);
NLSE2D_STEADY_F = [real(NLSE2D_STEADY_F(:)) ; imag(NLSE2D_STEADY_F(:))];
